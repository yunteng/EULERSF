...
namespace Grids
{
	...
	*/
    ...
    bool lookupDistanceAndNormalFast(const Matrix::Vector3<Real>& pos, Real& dist, Matrix::Vector3<Real>& normal) const;
	...
	*  that is lexicographically larger than (x,y,z) */
    ...
    inline bool getLocator(const Matrix::Vector3<Real>& pos, Locator *loc) const;
    ...
    void boundingBoxIndices(const Matrix::Vector3<Real>& mins, const Matrix::Vector3<Real>& maxs, Index iMins[3], Index iMaxs[3]);
